...
```
![ocean](/blog/static/images/ocean.jpg)
```
...
```js
<Image alt="ocean" src="/blog/static/images/ocean.jpg" width={256} height={128} />
```

_Note_: If you try to save the image, it is in webp format, if your browser supports it!

![ocean](/blog/static/images/ocean.jpeg)
...
- All images have to be stored in the `public` folder e.g `/blog/static/images/ocean.jpeg`
