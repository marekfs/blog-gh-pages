...
draft: false
layout: PostBanner
images: ['/blog/static/images/canada/mountains.jpg']
...
Features images served using `next/image` component. The locally stored images are located in a folder with the following path: `/blog/static/images/canada/[filename].jpg`
